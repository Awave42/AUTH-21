...
class StartTotoWidget extends StatefulWidget {
  StartTotoWidget({Key key}) : super(key: key);

  @override
  _StartTotoWidgetState createState() => _StartTotoWidgetState();
}

class _StartTotoWidgetState extends State<StartTotoWidget> {
