...
class CreatePdfspisokPpiAdminWidget extends StatefulWidget {
  CreatePdfspisokPpiAdminWidget({
    Key key,
    this.pluspdf,
  }) : super(key: key);
  ...
  @override
  _CreatePdfspisokPpiAdminWidgetState createState() =>
      _CreatePdfspisokPpiAdminWidgetState();
}

class _CreatePdfspisokPpiAdminWidgetState
    extends State<CreatePdfspisokPpiAdminWidget> {
  DateTime datePicked1;
  DateTime datePicked2;
  TextEditingController namePdfController;
  TextEditingController urlPdfController;
  PpiUgpuGp9022021Record newRecord;
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  try {
                                    final ppiUgpuGp9022021CreateData =
                                        createPpiUgpuGp9022021RecordData(
                                      namePdf: namePdfController.text,
                                      urlPdf: urlPdfController.text,
                                      creatAdd: datePicked2,
                                    );
                                    final ppiUgpuGp9022021RecordReference =
                                        PpiUgpuGp9022021Record.collection.doc();
                                    await ppiUgpuGp9022021RecordReference
                                        .set(ppiUgpuGp9022021CreateData);
                                    newRecord = PpiUgpuGp9022021Record
                                        .getDocumentFromData(
                                            ppiUgpuGp9022021CreateData,
                                            ppiUgpuGp9022021RecordReference);
                                    Navigator.pop(context);
